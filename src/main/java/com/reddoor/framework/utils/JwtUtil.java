...
public class JwtUtil {
    ...
    public static void main(String[] args) {
        ...
        User user = new User();
        user.setLoginName("testLoginUserName");
        user.setName("testUserName");
        String subject = new Gson().toJson(user);

        try {
            JwtUtil util = new JwtUtil();
            String jwt = util.createJWT(Constants.JWT_ID, Constants.JWT_ISSUER, subject, Constants.JWT_TTL);
